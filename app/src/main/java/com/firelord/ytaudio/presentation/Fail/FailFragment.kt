package com.firelord.ytaudio.presentation.Fail
...
import com.firelord.ytaudio.databinding.FragmentFailBinding
...
class FailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sharedViewModel.failReason.observe(viewLifecycleOwner){ failReason ->
            binding.tvPassDetail2.text = failReason
        }
        ...
        binding.progressBar4.indeterminateDrawable.setColorFilter(Color.parseColor("#DC4A4A"), PorterDuff.Mode.SRC_IN)
        binding.progressBar4.progressDrawable.setColorFilter(Color.parseColor("#DC4A4A"), PorterDuff.Mode.SRC_IN)

        binding.btDownloadAgain2.setOnClickListener {
            binding.root.findNavController().navigate(R.id.action_failFragment_to_homeFragment)
        }
    }
